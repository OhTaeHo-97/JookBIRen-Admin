package com.ablez.admin.second_db.repository;
...
@Repository
public abstract class SecondQuerydsl4RepositorySupport {
    private final Class domainClass;
    private Querydsl querydsl;
    private EntityManager em;
    private JPAQueryFactory queryFactory;

    public SecondQuerydsl4RepositorySupport(Class<?> domainClass) {
