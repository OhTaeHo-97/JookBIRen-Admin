...
public class Quiz3Ep01 {
    ...
    public Quiz3Ep01(Integer quizNumber, LocalDateTime firstAccessTime, LocalDateTime firstAnswerTime,
                     LocalDateTime firstHintTime, LocalDateTime secondHintTime, LocalDateTime getAnswerTime,
                     UserEp01 userId, QuizEp01 quiz) {
        this.quizNumber = quizNumber;
