package com.ablez.admin.first_db.repository;
...
@Repository
public abstract class FirstQuerydsl4RepositorySupport {
    private final Class domainClass;
    private Querydsl querydsl;
    private EntityManager em;
    private JPAQueryFactory queryFactory;

    public FirstQuerydsl4RepositorySupport(Class<?> domainClass) {
